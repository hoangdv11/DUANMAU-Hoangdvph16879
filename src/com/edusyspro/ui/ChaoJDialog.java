...
public class ChaoJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Chào mừng đến Trung tâm Lập trình City Pro");
        setPreferredSize(new java.awt.Dimension(800, 300));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        lblLogo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusyspro/icon/Banner.png"))); // NOI18N

        pgbLoading.setForeground(new java.awt.Color(255, 255, 255));
        pgbLoading.setPreferredSize(new java.awt.Dimension(150, 14));
